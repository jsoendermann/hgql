...
type HgqlData<D extends object> =
  | InitialState
  | LoadingState
  | SuccessState<D>
  | ErrorState
...
export function useManualQuery<D extends object>(
  queryString: string,
): [HgqlData<D>, () => void]
...
export function useQuery<D extends object>(
  queryString: string,
): [HgqlData<D>, () => void]
...
export function useQuery<D extends object, V extends object = never>(
  queryString: string,
  variables?: V,
) {
...
export const useMutation = <D extends object, V extends object>(
  ...
  useManualQuery<D, V>(queryString, (undefined as unknown) as V)
